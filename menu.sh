...
# (Podniesione z 3 do 6 - 60s okazało się zbyt krótkie i łapało zbyt
#  częste fałszywe bany przy dłuższych handoffach sieci (zmiana nadajnika,
#  przejazd granicy). Nadal wykrywa realne współdzielenie konta w ciągu
#  2 minut, bez utraty skuteczności ochrony przed nadużyciami.)
MIN_EXCEED_SCANS=6
